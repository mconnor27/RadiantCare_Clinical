...
# ---------------------------------------------------------------------------
# ---------------------------------------------------------------------------
# Specialty normalization — single source of truth lives in config.specialties.
# Re-exported here for back-compat with existing import sites.
# ---------------------------------------------------------------------------
from config.specialties import (  # noqa: E402
    ABMS_SPECIALTIES,
    NPI_SPECIALTY_MAP,
    normalize_specialty,
)
...
NAV_SECTIONS = [
    ...
    },
    {
        ...
        "pages": [
            ...
            {"label": "Scheduling", "path": "/scheduling", "icon": "tabler:calendar-event"},
        ],
    },
    {
        "section": "FINANCIAL",
