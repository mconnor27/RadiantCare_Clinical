"""
Contour Review task implementation
"""
import pandas as pd
import numpy as np
...
class ContourReviewTask(BaseTask):
    """Task for analyzing contour review (treatment planning) completion"""

    def __init__(self, df):
        """
        Initialize Contour Review task.
    ...
    def get_sidebar_layout(self, state=None):
        """Implemented in contour_review_sidebar.py"""
        from tasks.contour_review.contour_review_sidebar import create_sidebar_layout
        return create_sidebar_layout(self, state=state)

    def get_main_panel_layout(self):
        """Implemented in contour_review_panel.py"""
        from tasks.contour_review.contour_review_panel import create_main_panel_layout
        return create_main_panel_layout()

    def register_callbacks(self, app):
        """Implemented in contour_review_panel.py"""
        from tasks.contour_review.contour_review_panel import register_callbacks
